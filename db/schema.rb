...
ActiveRecord::Schema.define(version: 20160327103605) do
  ...
  add_index "share_visibilities", ["shareable_id", "shareable_type", "contact_id"], name: "shareable_and_contact_id", length: {"shareable_id"=>nil, "shareable_type"=>191, "contact_id"=>nil}, using: :btree
  add_index "share_visibilities", ["shareable_id", "shareable_type", "hidden", "contact_id"], name: "shareable_and_hidden_and_contact_id", length: {"shareable_id"=>nil, "shareable_type"=>191, "hidden"=>nil, "contact_id"=>nil}, using: :btree
